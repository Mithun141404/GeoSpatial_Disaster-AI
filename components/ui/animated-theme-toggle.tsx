...
export const AnimatedThemeToggle = ({ className, theme, onToggle }: { className?: string, theme: 'light' | 'dark', onToggle: () => void }) => {
  const isDark = theme === "dark";

  return (
    <Button
      onClick={onToggle}
      className={cn("px-2.5 bg-transparent border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-all", className)}
      variant="outline"
    >

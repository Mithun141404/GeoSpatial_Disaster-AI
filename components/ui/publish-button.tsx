...
export function PublishButton({
  ...
  holdDuration = 2000,
  className,
  labelIdle = "Execute Audit",
  labelPublishing = "Analyzing...",
  labelPublished = "Audit Complete"
}: PublishButtonProps) {
  ...
  return (
    <Button
      ...
      className={cn(
        "relative flex items-center justify-center gap-2 min-w-[200px] h-12 select-none transition-all duration-300 ease-in-out font-black uppercase tracking-widest text-xs rounded-xl",
